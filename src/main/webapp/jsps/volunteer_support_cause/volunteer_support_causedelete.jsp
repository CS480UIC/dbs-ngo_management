...
<form action="<c:url value='/Volunteer_support_causeServletDelete'/>" method="post">
	...
	Delete volunteer_id   :<input type="text" name="volunteer_id" value="${form.volunteer_id }"/>
	<span style="color: red; font-weight: 900">${errors.volunteer_id }</span>
	<br/>
	Delete support_cause_id   :<input type="text" name="support_cause_id" value="${form.support_cause_id }"/>
