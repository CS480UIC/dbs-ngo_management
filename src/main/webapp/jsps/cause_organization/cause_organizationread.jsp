...
<html>
  <head>
    ...
    <title>Read cause_organization</title>
  ...
  <body>
  <h1>Read cause_organization</h1>
<p style="color: red; font-weight: 900">${msg }</p>
<form action="<c:url value='/Cause_organizationServletRead'/>" method="post">
...
<%-- 	Password：<input type="password" name="password" value="${form.password }"/>
	...
	<br/> --%>
	<input type="submit" value="Read cause_organization"/>
</form>
  </body>
</html>
