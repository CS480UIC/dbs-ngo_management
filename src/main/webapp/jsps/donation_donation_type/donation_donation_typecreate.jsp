...
<html>
  <head>
    ...
    <title>donation_donation_type Create</title>
  ...
  <body>
  <h1>donation_donation_type Create</h1>
<form action="<c:url value='/Donation_donation_typeServletCreate'/>" method="post">
	...
	<br/>
	<input type="submit" value="Create donation_donation_type"/>
</form>
  </body>
</html>
