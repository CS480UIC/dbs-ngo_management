...
<html>
  <head>
    ...
    <title>Read donation_donation_type</title>
  ...
  <body>
  <h1>Read donation_donation_type</h1>
<p style="color: red; font-weight: 900">${msg }</p>
<form action="<c:url value='/Donation_donation_typeServletRead'/>" method="post">
...
<%-- 	Password：<input type="password" name="password" value="${form.password }"/>
	...
	<br/> --%>
	<input type="submit" value="Read donation_donation_type"/>
</form>
  </body>
</html>
